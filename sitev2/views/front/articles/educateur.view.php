...
<div class="container-fluid">
    <div class="row">
        <div class="col-5 p-2">
            <img class="img-fluid img-thumbnail" src="<?= URL ?>public/content/images/website/articles/educateur_canin.jpg" alt="Educateur canin" title="Formation au dressage du chien">
        </div>
        <div class="col-7 p-2">
            <p class="h4">
